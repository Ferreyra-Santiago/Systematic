...
const Footer = () => {
  return (
<footer className=" bg-white shadow md:px-6">
    ...
    <div className="sm:flex sm:items-center sm:justify-between">
        ...
        <ul className="flex flex-wrap items-center mb-6 text-sm text-gray-700 sm:mb-0">
            ...
            <li>
                <a href="/preguntasFrecuentes" className="hover:underline">Preguntas Frecuentes</a>
            </li>
        </ul>
    </div>
    <div className="mt-3 sm:flex sm:items-center sm:justify-between">
        ...
        <div className="flex mt-4 space-x-6 sm:justify-center sm:mt-0">
            ...
            <a href="https://www.instagram.com/systematic.stw/" target="blank_" className="text-gray-700 hover:text-gray-900">
